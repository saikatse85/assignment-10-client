        ...
        <div className="glass-card rounded-2xl shadow-2xl border border-white/20 overflow-hidden transition hover:shadow-3xl hover:-translate-y-1 duration-300">
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              <div className="flex items-center gap-2 bg-white/50 dark:bg-black/20 backdrop-blur px-3 py-2 rounded-lg border border-gray-200/30">
            ...
            {/* Description */}
            <div className="p-4 rounded-xl bg-white/50 dark:bg-black/20 backdrop-blur border border-gray-200/30">
